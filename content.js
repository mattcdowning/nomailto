...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.addEventListener('click', 'a[href^="mailto:"]', function() {
    ...
    var contain =
      '<div id="dang" style="margin: 0 auto !important; text-align: center !important; padding-bottom: 2rem !important;">' +
      everything +
      '</div>'
